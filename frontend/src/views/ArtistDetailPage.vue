...
import {
  ...
  NInputNumber, NDynamicTags, NTag, NUpload, NSelect, useMessage,
} from 'naive-ui'
import TagEditor from '../components/TagEditor.vue'
import {
  getArtist, tagArtist, reclassifyArtist, saveArtist,
  uploadArtistImage, toggleArtistFavorite, refreshThumb, type CfDetail,
...
async function refreshCover() {
  ...
  try {
    await refreshThumb('artist', source.value, key.value)
